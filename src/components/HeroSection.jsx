...
const HeroSection = () => {
	return (
		<section className="hero-section text-center mt-32 flex flex-col">
			...
			<h1 className="tex-4xl font-extrabold leading-[1.15] text-black sm:text-6xl">
				Launch Your Sass
				<br />
			...
			<h2 className="mt-5 text-gray-600 sm:text-xl">Nexx is an open-source tool for developers who want to launch their ideas faster.</h2>
