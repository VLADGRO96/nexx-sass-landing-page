...
const PlanCard = ({ price, title, description, features, isPopular }) => {
	return (
		<div className="plan-card border flex flex-col justify-between bg-white/20 backdrop-blur-lg rounden-lg h-full p-6 hover:shadow-md text-left relative">
			{
				isPopular && (
			...
			<div>
				<button className="bg-indigo-500 hover:bg-indigo-600 py-2 mt-3 rounded-lg text-white w-full">Select Plan</button>
			</div>
		</div>
	)
};
